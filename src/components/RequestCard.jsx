  ...
  return (
    <div className="group relative w-full bg-gradient-to-br from-slate-900 via-black to-slate-900 border border-purple-500/20 rounded-3xl overflow-hidden shadow-xl hover:border-purple-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/10">
      ...
      <div className="relative h-80 w-full bg-black overflow-hidden">
        ...
        {/* Status Badge */}
        <div className="absolute bottom-12 right-4 px-3 py-1 bg-amber-500/20 border border-amber-400/40 rounded-full">
          <p className="text-amber-300 font-medium text-xs uppercase tracking-wider">
            Pending
          </p>
        </div>
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex gap-3 pt-4">
          <button
            ...
            className="flex-1 py-2 rounded-full border border-pink-500/50 text-pink-400 font-bold hover:bg-pink-500/10 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 transition-all uppercase text-xs tracking-widest"
          >
            Reject
          </button>
          <button
            ...
            className="flex-1 py-2 rounded-full bg-gradient-to-r from-emerald-600 to-blue-600 text-white font-bold hover:from-emerald-500 hover:to-blue-500 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-emerald-500/20 active:scale-95 transition-all uppercase text-xs tracking-widest"
          >
            Accept
          </button>
        </div>
