    ...
    <div className="flex items-center justify-center h-screen">
      ...
      <div>
        ...
        >
          ...
          <button
            type="submit"
            className="mt-2 w-full h-11 rounded-full text-white bg-gradient-to-r from-pink-600 to-blue-600 hover:from-pink-500 hover:to-blue-500 transition font-medium"
          >
            Login
          </button>
